        ...
        try {
            ...
            if (stp === "add") {
                ...
                if (channel.type !== ChannelType.GuildText)
                    return interaction.reply({ content: `${lang.msg125}`, ephemeral: true }).catch(e => {});
                ...
                if (channel_filter?.length > 0)
                    return interaction.reply({ content: lang.msg124, ephemeral: true }).catch(e => {});
            ...
            if (stp === "remove") {
                ...
                const channel_filter = data?.channels?.filter(x => x.channel === channel.id);
                if (!channel_filter?.length > 0)
                    return interaction.reply({ content: lang.msg122, ephemeral: true }).catch(e => {});
