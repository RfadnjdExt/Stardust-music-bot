                                ...
                                try {
                                    ...
                                    if (data?.channels?.length > 0) {
                                        let channel_control = await data?.channels?.filter(
                                            x => !interaction?.guild?.channels?.cache?.get(x?.channel)
                                        );
                                        ...
                                        return interaction?.reply({
                                            content: `${lang.message3}: **${
                                                props?.permissions
                                                    ...
                                                    ?.replace("0x0000000000000800", "SEND MESSAGES") || "SEND MESSAGES"
                                            }**`,
                                            ephemeral: true
                                        });
                                    }
                    ...
                    case "playlistModal":
                        {
                            ...
                            const music_filter = playlist?.musics?.filter(
                                m => m.playlist_name === name && m.music_name === queue?.songs[0]?.name
                            );
